    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          >
            🚀 Customer dashboard coming soon! You'll be able to track your deliveries, manage orders, and more.
          </p>
        </motion.div>
        ...
        >
          {[
            { title: "Active Orders", value: "0", icon: "📦" },
            { title: "Delivered", value: "0", icon: "✅" },
            { title: "Total Spent", value: "$0.00", icon: "💰" },
          ].map((stat, idx) => (
            <motion.div
              key={idx}
              whileHover={{ y: -4 }}
